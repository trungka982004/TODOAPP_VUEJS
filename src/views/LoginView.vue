...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800 dark:from-neutral-900 dark:via-indigo-950 dark:to-neutral-900 p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md bg-white/90 dark:bg-neutral-900/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 dark:border-neutral-700/50 p-8 space-y-6 relative z-10">
      ...
      <div class="text-center">
        ...
        <h1 class="text-3xl font-extrabold text-neutral-800 dark:text-neutral-100 tracking-tight">Welcome Back</h1>
        <p class="text-neutral-500 dark:text-neutral-400 mt-2">Please enter your details to sign in</p>
      </div>
      ...
      <form @submit.prevent="handleLogin" class="space-y-5">
        ...
        <button 
          ...
          class="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 disabled:from-indigo-400 disabled:to-purple-400 text-white font-bold py-3.5 px-4 rounded-xl transition-all shadow-lg shadow-indigo-500/30 mt-4 transform hover:-translate-y-0.5"
        >
      ...
      <p class="text-center text-sm text-neutral-600 dark:text-neutral-400 pt-2">
        ...
        <button @click="goToRegister" class="font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 focus:outline-none transition-colors">
          Sign up for free
        </button>
      </p>
